...
export default function FileDisplay(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 w-full max-w-prose mx-auto bg-slate-300 rounded-lg'>
            <h1 className='font-semibold text-4xl sm:text-5xl md:text-6xl'>get-your<span className='text-blue-400 bold'>VOICE</span></h1>
