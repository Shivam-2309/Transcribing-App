...
export default function HomePage(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20 bg-slate-300 rounded-lg'>
            <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl'>get<span className='text-blue-400 bold'>VOICE</span></h1>
            ...
            <p className='italic text-slate-700'>Made By: Shivam Kapoor</p>
            <p className='italic text-slate-700'>2K22/CO/434</p>
        </main>
    )
}